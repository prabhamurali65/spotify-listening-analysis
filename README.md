...
**Spotify Listening Analysis** demonstrates how raw listening-history data can be transformed into an interactive analytical dashboard using **Power BI and DAX**.

The project combines **data preparation, analytical calculations, visualization, and data storytelling** to make listening-history data easier to explore and understand.
